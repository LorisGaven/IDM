...
public class ResourceUtilisationItemProvider extends ProcessElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceUtilisation_quantity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceUtilisation_quantity_feature", "_UI_ResourceUtilisation_type"),
				 SimplepdlPackage.Literals.RESOURCE_UTILISATION__QUANTITY,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceUtilisation_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceUtilisation_name_feature", "_UI_ResourceUtilisation_type"),
				 SimplepdlPackage.Literals.RESOURCE_UTILISATION__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ResourceUtilisation)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ResourceUtilisation_type") :
			getString("_UI_ResourceUtilisation_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ResourceUtilisation.class)) {
			case SimplepdlPackage.RESOURCE_UTILISATION__QUANTITY:
			case SimplepdlPackage.RESOURCE_UTILISATION__NAME:
