...
public class ProcessItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimplepdlPackage.Literals.PROCESS__PROCESSELEMENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(simplepdl.Process.class)) {
			case SimplepdlPackage.PROCESS__NAME:
				...
				return;
			case SimplepdlPackage.PROCESS__PROCESSELEMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimplepdlPackage.Literals.PROCESS__PROCESSELEMENTS,
		...
		newChildDescriptors.add
			(createChildParameter
				(SimplepdlPackage.Literals.PROCESS__PROCESSELEMENTS,
				 SimplepdlFactory.eINSTANCE.createResourceUtilisation()));
	}
