...
public class WorkDefinitionItemProvider extends ProcessElementItemProvider {
	...
	/**
	 * This adds a property descriptor for the Resourceutilisation feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addResourceutilisationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkDefinition_resourceutilisation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkDefinition_resourceutilisation_feature", "_UI_WorkDefinition_type"),
				 SimplepdlPackage.Literals.WORK_DEFINITION__RESOURCEUTILISATION,
				 true,
				 false,
				 true,
				 null,
