...
public class PDLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PDLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getWorkDefinitionAccess().getResourceutilisationAssignment_4(), "rule__WorkDefinition__ResourceutilisationAssignment_4");
			...
			builder.put(grammarAccess.getResourceUtilisationAccess().getNameAssignment_1(), "rule__ResourceUtilisation__NameAssignment_1");
			builder.put(grammarAccess.getResourceUtilisationAccess().getQuantityAssignment_2(), "rule__ResourceUtilisation__QuantityAssignment_2");
			builder.put(grammarAccess.getResourceUtilisationAccess().getResourceAssignment_3(), "rule__ResourceUtilisation__ResourceAssignment_3");
		}
	}
