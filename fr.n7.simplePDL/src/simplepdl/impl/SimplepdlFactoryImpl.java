...
public class SimplepdlFactoryImpl extends EFactoryImpl implements SimplepdlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SimplepdlPackage.RESOURCE_UTILISATION: return createResourceUtilisation();
			default:
	 ...
	 * @generated
	 */
	public ResourceUtilisation createResourceUtilisation() {
		ResourceUtilisationImpl resourceUtilisation = new ResourceUtilisationImpl();
