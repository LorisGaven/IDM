 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getResourceutilisation <em>Resourceutilisation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	/**
	 * The cached value of the '{@link #getResourceutilisation() <em>Resourceutilisation</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<ResourceUtilisation> resourceutilisation;
	 ...
	 * @generated
	 */
	public EList<ResourceUtilisation> getResourceutilisation() {
		if (resourceutilisation == null) {
			resourceutilisation = new EObjectResolvingEList<ResourceUtilisation>(ResourceUtilisation.class, this, SimplepdlPackage.WORK_DEFINITION__RESOURCEUTILISATION);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__NAME:
				return getName();
			case SimplepdlPackage.WORK_DEFINITION__RESOURCEUTILISATION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__NAME:
				...
				return;
			case SimplepdlPackage.WORK_DEFINITION__RESOURCEUTILISATION:
				getResourceutilisation().clear();
				getResourceutilisation().addAll((Collection<? extends ResourceUtilisation>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__RESOURCEUTILISATION:
				return resourceutilisation != null && !resourceutilisation.isEmpty();
		}
