...
public class SimplepdlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SimplepdlPackage.RESOURCE_UTILISATION: {
				ResourceUtilisation resourceUtilisation = (ResourceUtilisation)theEObject;
				T result = caseResourceUtilisation(resourceUtilisation);
				if (result == null) result = caseProcessElement(resourceUtilisation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Resource Utilisation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Resource Utilisation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseResourceUtilisation(ResourceUtilisation object) {
		return null;
	}
