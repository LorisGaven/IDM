...
public interface SimplepdlPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Processelements</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PROCESS__PROCESSELEMENTS = 1;
	...
	/**
	 * The feature id for the '<em><b>Resourceutilisation</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int WORK_DEFINITION__RESOURCEUTILISATION = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int RESOURCE_UTILISATION__QUANTITY = PROCESS_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RESOURCE_UTILISATION__RESOURCE = PROCESS_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RESOURCE_UTILISATION__NAME = PROCESS_ELEMENT_FEATURE_COUNT + 2;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link simplepdl.Process#getProcesselements <em>Processelements</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Processelements</em>'.
	...
	/**
	 * Returns the meta object for the reference list '{@link simplepdl.WorkDefinition#getResourceutilisation <em>Resourceutilisation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Resourceutilisation</em>'.
	 * @see simplepdl.WorkDefinition#getResourceutilisation()
	 * @see #getWorkDefinition()
	 * @generated
	 */
	EReference getWorkDefinition_Resourceutilisation();
	...
	/**
	 * Returns the meta object for the attribute '{@link simplepdl.ResourceUtilisation#getQuantity <em>Quantity</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Quantity</em>'.
	 * @see simplepdl.ResourceUtilisation#getQuantity()
	 * @see #getResourceUtilisation()
	 * @generated
	 */
	EAttribute getResourceUtilisation_Quantity();
	...
	/**
	 * Returns the meta object for the attribute '{@link simplepdl.ResourceUtilisation#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see simplepdl.ResourceUtilisation#getName()
	 * @see #getResourceUtilisation()
	 * @generated
	 */
	EAttribute getResourceUtilisation_Name();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Processelements</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference PROCESS__PROCESSELEMENTS = eINSTANCE.getProcess_Processelements();
		...
		/**
		 * The meta object literal for the '<em><b>Resourceutilisation</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference WORK_DEFINITION__RESOURCEUTILISATION = eINSTANCE.getWorkDefinition_Resourceutilisation();
		 ...
		 * @generated
		 */
		EAttribute RESOURCE_UTILISATION__QUANTITY = eINSTANCE.getResourceUtilisation_Quantity();
		 ...
		 * @generated
		 */
		EAttribute RESOURCE_UTILISATION__NAME = eINSTANCE.getResourceUtilisation_Name();
