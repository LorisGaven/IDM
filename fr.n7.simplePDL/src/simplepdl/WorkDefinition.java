 ...
 *   <li>{@link simplepdl.WorkDefinition#getResourceutilisation <em>Resourceutilisation</em>}</li>
 * </ul>
 *
...
public interface WorkDefinition extends ProcessElement {
	...
	/**
	 * Returns the value of the '<em><b>Resourceutilisation</b></em>' reference list.
	 * The list contents are of type {@link simplepdl.ResourceUtilisation}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Resourceutilisation</em>' reference list.
	 * @see simplepdl.SimplepdlPackage#getWorkDefinition_Resourceutilisation()
	 * @model
	 * @generated
	 */
	EList<ResourceUtilisation> getResourceutilisation();
