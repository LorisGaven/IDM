...
@after {
	...
	(
		...
		{
			$current = $this_ResourceUtilisation_4.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleResourceUtilisation returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getResourceUtilisationRule()); }
	iv_ruleResourceUtilisation=ruleResourceUtilisation
	{ $current=$iv_ruleResourceUtilisation.current; }
	EOF;

// Rule ResourceUtilisation
ruleResourceUtilisation returns [EObject current=null]
@init {
	enterRule();
}
@after {
